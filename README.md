...
无需访问 GitHub，直接从 SkillHub 国内源安装：

```bash
npx -y skills install https://skillhub.cn/skills/apti-skill
```

或访问 [SkillHub - APTI](https://skillhub.cn/skills/apti-skill) 页面查看更多安装方式。

### 方式三：手动下载 SKILL.md

1. 从 [SkillHub](https://skillhub.cn/skills/apti-skill) 或 [GitHub](./SKILL.md) 下载 `SKILL.md`，放入项目根目录
2. 在 Agent 中执行：
